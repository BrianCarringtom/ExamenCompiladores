...
tokens = ('PALABRAR','IDENTIFICADOR','SIMBOLO','OPERADOR','NUMERO','FINAL', 'NOESTADEFINIDO')

palabra_reser = ['base', 'altura', 'Area']
identificador = ['Brian', 'Isaac', 'Septiembre']
operador = ['*', '/']
...
ventana.title("Analizador Lexico BIVM")
ventana.config(bg='#808080')

entrada_texto = tk.Text(ventana, font=("Arial", 12), bg="white", fg="black", height=8, width=50)
entrada_texto.place(x=100, y=70)

texto_token = tk.Text(ventana, font=("Arial", 12), bg="white", fg="black", height=20, width=17)
texto_token.place(x=100, y=270)
texto_lexema = tk.Text(ventana, font=("Arial", 12), bg="white", fg="black", height=20, width=17)
texto_lexema.place(x=250, y=270)
texto_linea = tk.Text(ventana, font=("Arial", 12), bg="white", fg="black", height=20, width=17)
texto_linea.place(x=400, y=270)


titulo_salida = tk.Label(ventana, text="Token                 Lexema                Linea", font=("Arial", 14), bg='#FF0000', fg='white')
